    ...
    return (
        <div className="flex flex-col gap-1.5 mb-2">
            ...
            <input
                ...
                className="px-4 py-2 rounded-md bg-slate-100 text-slate-500 border border-slate-900/10 dark:border-gray-700 dark:bg-gray-800 w-full dark:text-gray-400 outline-none"
