    ...
    return (
        <>
                    ...
                    <div className="flex flex-col items-center justify-center gap-1.5 w-full">
                        {
                            analysisItem.values?.map((item, index) =>
                                <div className="w-full bg-slate-100 dark:bg-steel-gray-800 rounded px-2.5 py-1 flex items-center" key={index}>
                                    <span className="flex-1 text-sm whitespace-nowrap overflow-hidden text-ellipsis">
                                        {item.value}
                                    </span>
                                    <span className="w-10 font-bold bg-slate-200 dark:bg-steel-gray-700 rounded-xl px-2 flex items-center justify-center text-xs py-1">
                                        {item.count}
                                    </span>
                                </div>
                            )
            ...
            <div className="mt-2 grid grid-cols-4 items-center justify-center gap-5">
                <div className="rounded bg-slate-100 dark:bg-steel-gray-800 px-5 py-5 flex items-center justify-center gap-2">
