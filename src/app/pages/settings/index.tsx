                ...
                <div className="flex flex-col p-4 gap-2">
                    <Link to={`/${workspace.code}/settings`}>
                        <div className={
                            ...
                            + ` ${isActive('settings') ? 'bg-slate-100 dark:bg-cinder-600/80' : ''}`
                        }>
                    ...
                    <Link to={`/${workspace.code}/settings/members`}>
                        <div className={
                            "px-3 py-2 hover:bg-slate-100 dark:hover:bg-cinder-600/80 cursor-pointer text-sm flex items-center gap-2 rounded transition"
                            + ` ${isActive('members') ? 'bg-slate-100 dark:bg-cinder-600/80' : ''}`
                        }>
                    ...
                    <Link to={`/${workspace.code}/settings/billing`}>
                        <div className={
                            "px-3 py-2 hover:bg-slate-100 dark:hover:bg-cinder-600/80 cursor-pointer text-sm flex items-center gap-2 rounded transition"
                            + ` ${isActive('billing') ? 'bg-slate-100 dark:bg-cinder-600/80' : ''}`
                        }>
