...
const FormItem: FC<Props> = ({ form }) => {
    ...
    return (
        <div className="flex items-center p-2 rounded-md border border-slate-900/10 bg-zinc-50 dark:border-transparent dark:bg-steel-gray-900 dark:hover:bg-steel-gray-800 transition relative group">
