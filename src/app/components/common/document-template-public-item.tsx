...
const DocumentTemplatePublicItem: FC<Props> = ({ documentTemplate, onClick }) => {
    ...
    return (
        <div
            onClick={onClick}
            className="cursor-pointer flex items-center p-2 rounded-md border border-slate-900/10 bg-slate-50 dark:border-transparent dark:bg-steel-gray-900 relative group"
        >
