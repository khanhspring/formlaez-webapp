...
const Textarea: FC<Props> = ({
    ...
    return (
        <textarea
            ...
            className={
                'border bg-slate-100 border-slate-900/10 dark:border-steel-gray-800 dark:bg-steel-gray-900 dark:hover:border-steel-gray-700 shadow-sm rounded outline-none px-4 py-2 resize-none placeholder:text-gray-400 '
