        ...
        <div className="w-full relative flex gap-2">
            {
                options.map((val, index) => (
                    <span
                        ...
                        key={index}
                        className={
                            `rounded border bg-white border-slate-900/10 hover:bg-slate-200 dark:border-steel-gray-800 dark:bg-steel-gray-900 flex-1 h-10 flex items-center justify-center cursor-pointer dark:hover:bg-steel-gray-700 transition `
