            ...
            }
            {
                options.map((item, index) => (
                    <span
                        ...
                        key={index}
                        className={
                            `rounded border bg-slate-100 border-slate-900/10 hover:bg-slate-200 dark:border-gray-700 dark:bg-gray-800 cursor-pointer dark:hover:bg-gray-700 px-2.5 py-1 w-auto text-base transition `
