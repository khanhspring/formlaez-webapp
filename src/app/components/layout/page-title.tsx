...
const PageTitle: FC<Props> = ({title, actions}) => {
    return (
        <div className="py-2 border-b bg-white dark:bg-cinder-900 border-slate-200 dark:border-cinder-600 z-20 sticky top-[64px] flex items-center justify-between">
