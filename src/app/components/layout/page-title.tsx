...
const PageTitle: FC<Props> = ({ title, actions, shortTitle = defaultIcon, className, iconClassName, prefix }) => {
    ...
    return (
        <div className={
            "w-full max-w-full overflow-hidden py-2 border-b border-slate-900/10 bg-white dark:border-steel-gray-900 z-20 sticky top-[64px] flex items-center justify-between gap-10 dark:bg-steel-gray-950"
            + ` ${className}`
        }>
