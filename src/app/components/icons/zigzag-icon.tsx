...
const ZigzagIcon: FC<HTMLAttributes<any>> = ({ className }) => {
    return (
        <svg
        ...
        >
			...
			c2.49,2.724,6.52-1.326,4.04-4.039C59.543,30.562,56.994,27.537,54.411,24.535z" data-original="#000000" className=""></path>
                    </g>
                </g>
                <g>
                </g>
